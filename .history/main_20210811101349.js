...
function getNumberedMonthDifference(beforeDate, afterDate) {
  ...
  // get the literal day e.g is 28 > 13. If so, then -1 off return value. If not, do nothing
  const dayOffset = beforeDate.getDate() > afterDate.getDate() ? -1 : 0;
  console.log("beforeDate", beforeDate.getDate());
  console.log("afterDate", afterDate.getDate());
