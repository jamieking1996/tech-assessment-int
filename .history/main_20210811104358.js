...
function getDateDifference(beforeDate, afterDate) {
  ...
  return `${yearDiff(beforeDate, afterDate) ? yearDiff(beforeDate, afterDate) + " " : ''}${monthDifference(beforeDate, afterDate) ? monthDifference(beforeDate, afterDate) + " " : ''}${totalDayDiff(beforeDate, afterDate)}`;
}
